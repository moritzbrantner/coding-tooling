...
describe("source dependency mode", () => {
  test("renders deterministic exact-revision Cargo patches", () => {
    ...
    expect(rendered.content.indexOf('"a-package"')).toBeLessThan(rendered.content.indexOf('"z-package"'));
  ...
  test("activates and deactivates only the managed Cargo config", () => {
    ...
    expect(readFileSync(cargoConfig, "utf8").startsWith("# Generated by coding-tooling source-deps.")).toBe(
      true,
    );
