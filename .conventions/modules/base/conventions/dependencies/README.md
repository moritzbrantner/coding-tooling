...
## DEP-012 — Prove dependency ranges as a clean consumer
...
- Consumer verification for a deterministic compatibility point must install exact versions derived from the package's declared contract rather than floating caret, tilde, or inequality ranges that change meaning over time.
